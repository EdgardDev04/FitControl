...
namespace FitControl.Infrastructure.Persistence.Repositories
{
    public class MembershipPlanRepository : IMembershipPlanRepository
    {
        ...
        public async Task<ICollection<MembershipPlan>> GetActiveMembershipPlansAsync() => await _context.MembershipPlans.Where(m => m.IsActive).ToListAsync();
        ...
        public async Task<ICollection<MembershipPlan>> GetInactiveMembershipPlansAsync() => await _context.MembershipPlans.Where(m => m.IsActive == false).ToListAsync();
